...
const DICT = {
  en: {
    ...
    "ship.free": "Free",
    "ship.note":
      "Live rates from Shopify — Correios for Brazil, international carriers worldwide. Final cost is confirmed at checkout.",
    ...
    "product.family": "More from the collab",
    "product.zoom": "Click to inspect",
    "product.scanning": "Scroll to zoom · Esc to close",
    "tab.info": "Info",
    "tab.specs": "Specs",
    "tab.care": "Care",
    ...
    "checkout.securenote":
      "Shipping, taxes and discounts are confirmed in the secure Shopify checkout.",
    "checkout.free": "Free",
    ...
    "footer.brazil.copy":
      "Shipping costs are calculated automatically through the Correios integration during checkout. Estimated delivery time is between 2 and 15 business days depending on the destination state.",
    "footer.world": "Worldwide",
    "footer.world.copy":
      "International orders are shipped using Shopify's international shipping system. Estimated delivery time is between 20 and 40 business days depending on the destination country and customs processing.",
    "footer.brand": "Brand",
    "footer.brand.copy":
  ...
  pt: {
    ...
    "ship.free": "Grátis",
    "ship.note":
      "Valores em tempo real da Shopify — Correios no Brasil e transportadoras internacionais no exterior. O valor final é confirmado no checkout.",
    "account.title": "Conta",
    ...
    "product.family": "Mais da collab",
    "product.zoom": "Clique para inspecionar",
    "product.scanning": "Role para ampliar · Esc para fechar",
    "tab.info": "Info",
    "tab.specs": "Especif.",
    "tab.care": "Cuidados",
    "tab.shipping": "Envio",
    ...
    "checkout.securenote":
      "Frete, impostos e descontos são confirmados no checkout seguro da Shopify.",
    ...
    "footer.brazil.copy":
      "O frete é calculado automaticamente pela integração com os Correios durante o checkout. O prazo estimado de entrega é de 2 a 15 dias úteis, conforme o estado de destino.",
    "footer.world": "Internacional",
    "footer.world.copy":
      "Pedidos internacionais são enviados pelo sistema de envio internacional da Shopify. O prazo estimado é de 20 a 40 dias úteis, conforme o país de destino e o processamento aduaneiro.",
    "footer.brand": "Marca",
    "footer.brand.copy":
  ...
  de: {
    ...
    "ship.free": "Kostenlos",
    "ship.note":
      "Live-Tarife von Shopify — Correios in Brasilien, internationale Carrier weltweit. Der Endpreis wird an der Kasse bestätigt.",
    "account.title": "Konto",
    ...
    "product.photos": "Fotos",
    "product.family": "Mehr aus der Kollaboration",
    "product.zoom": "Zum Prüfen klicken",
    "product.scanning": "Scrollen zum Zoomen · Esc zum Schließen",
    "tab.info": "Info",
    "tab.specs": "Daten",
    "tab.care": "Pflege",
    "tab.shipping": "Versand",
    "product.prev": "Vorheriges Produkt",
    "product.next": "Nächstes Produkt",
    ...
    "checkout.securenote":
      "Versand, Steuern und Rabatte werden im sicheren Shopify-Checkout bestätigt.",
    ...
    "footer.brazil.copy":
      "Die Versandkosten werden während des Checkouts automatisch über die Correios-Integration berechnet. Die geschätzte Lieferzeit beträgt 2 bis 15 Werktage je nach Zielbundesstaat.",
    "footer.world": "Weltweit",
    "footer.world.copy":
      "Internationale Bestellungen werden über das internationale Versandsystem von Shopify verschickt. Die geschätzte Lieferzeit beträgt 20 bis 40 Werktage je nach Zielland und Zollabfertigung.",
    "footer.brand": "Marke",
    "footer.brand.copy":
  ...
  ko: {
    ...
    "ship.free": "무료",
    "ship.note":
      "Shopify 실시간 요금 — 브라질은 Correios, 해외는 국제 배송사. 최종 금액은 결제 시 확정됩니다.",
    "account.title": "계정",
    "account.login": "로그인",
    ...
    "product.photos": "사진",
    "product.family": "컬래버레이션 더 보기",
    "product.zoom": "클릭해서 살펴보기",
    "product.scanning": "스크롤로 확대 · Esc로 닫기",
    "tab.info": "정보",
    "tab.specs": "사양",
    "tab.care": "관리",
    "tab.shipping": "배송",
    ...
    "checkout.done": "주문 완료",
    "checkout.thanks":
      "감사합니다. 확인 메일이 곧 발송됩니다. 모든 제품은 스튜디오에서 직접 포장됩니다.",
    ...
    "footer.brazil": "브라질",
    "footer.brazil.copy":
      "배송비는 결제 시 Correios 연동을 통해 자동으로 계산됩니다. 예상 배송 기간은 도착 주에 따라 2~15 영업일입니다.",
    "footer.world": "해외 배송",
    "footer.world.copy":
      "해외 주문은 Shopify의 국제 배송 시스템으로 발송됩니다. 예상 배송 기간은 도착 국가와 통관 처리에 따라 20~40 영업일입니다.",
    "footer.brand": "브랜드",
    "footer.brand.copy":
